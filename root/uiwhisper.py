...
class WhisperDialog(ui.ScriptWindow):
	...
	def LoadDialog(self):
		...
		if app.ENABLE_MULTI_LANGUAGE_SYSTEM:
			self.languageFlag.SetPosition(170, 10)
			self.empireFlag.SetPosition(201, 10)
	...
	if app.ENABLE_MULTI_LANGUAGE_SYSTEM:
		...
		def SetFlag(self, languageID, empireID):
			...
			self.languageFlag.LoadImage("d:/ymir work/ui/flagschat/%s.tga" % (languageID))
			self.empireFlag.LoadImage("d:/ymir work/ui/empirechat/empire_%s_256.dds" % (empireID))
