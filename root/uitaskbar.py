...
class TaskBar(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		if app.ENABLE_ANTI_MULTIPLE_FARM:
			...
			tmpButton = ui.MakeButton(self, xLeft - 40, pos_y, "", "d:/ymir work/ui/anti_multiple_farm/", "anti_multiple_farm_bt_norm.png", "anti_multiple_farm_bt_hover.png", "anti_multiple_farm_bt_down.png")
