...
class InventoryWindow(ui.ScriptWindow):
	...
	def __init__(self, interface):
		...
		ui.ScriptWindow.__init__(self)
		self.isOpenedBeltWindowWhenClosingInventory = 0		# AI¨¬¡ÍAa¢¬¢ç ¢¥YA¡í ¢Ò¡× ¨¬¡×¨¡¢ç AI¨¬¡ÍAa¢¬¢ç¡Æ¢® ¢¯¡©¡¤AAO¨úu¢¥AAo ¢¯¨Ï¨¬I-_-; ©ø¡¿AI©öO ¢´¢¬¢´¥ì
	...
	def Show(self):
		...
		# AI¨¬¡ÍAa¢¬¢ç¢¬| ¢¥YA¡í ¢Ò¡× ¨¬¡×¨¡¢ç AI¨¬¡ÍAa¢¬¢ç¡Æ¢® ¢¯¡©¡¤AAO¨úu¢¥U¢¬e ¡Æ¡ÆAI ¢¯¡©¥ì¥ì¡¤I CO.
		if self.wndBelt:
