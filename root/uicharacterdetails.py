...
bonus_list = [
	["PvM",
		[
			...
			[item.APPLY_ATTBONUS_METIN,139],
			[item.APPLY_ATTBONUS_BOSS,138],
	...
	["Elementi",
		[
			...
			[item.APPLY_ATTBONUS_ELEC,155],
			[item.APPLY_ATTBONUS_WIND,156],
			[item.APPLY_ATTBONUS_EARTH,157],
			[item.APPLY_ATTBONUS_DARK,158],
