	...
	(
		## Board and buttons
		{
			...
			(
				...
				{
					"name" : "BpassStatus", "type" : "text", "x" : 370+10, "y" : 35, "text" : "Info Misiuni", 
				},
				{
					"name" : "Text1Info","type" : "text","x" : 320+3,"y" : 54,"text" : "- Nume Misiune: ",
				},
				{
				...
				{
					"name" : "Text7Info","type" : "text","x" : 378,"y" : 154 + 24,"text" : "|cffffff00Recompense finale",
				},
				{
