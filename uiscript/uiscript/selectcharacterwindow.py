...
window = {
	...
	(
...

		{
			...
			"type" : "image",
			"x" : 135,
			"y" : SCREEN_HEIGHT/2 - 416/2 - 65,
			"image" : ROOT_PATH_N + "bg_select.png",
		},

		{
			...
			"type" "image",
			"x" : 0,
			"y" : SCREEN_HEIGHT/2 - 416/2 - 65 - 60,
			"image" : ROOT_PATH_N + "linea_up.png",
		},

		{
			...
			"type" "image",
			"x" : 0,
			"y" : SCREEN_HEIGHT/2 + 416/2 + 60,
			"image" : ROOT_PATH_N + "linea_up.png",
		},
		{
			"name" : "board_line_down",
			"type" "image",
			"x" : 0,
			"y" : SCREEN_HEIGHT/2 + 416/2 + 60+25,
			"image" : ROOT_PATH_N + "linea_up.png",
		},
