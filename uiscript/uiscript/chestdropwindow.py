	...
	(
		{
			...
			(
				## Title
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x": 250, "y":3, "text": "Previzualizare Cufãr", "text_horizontal_align":"center" },
					),
				},
				...
				
				{
					...
					"over_image" 	: "d:/ymir work/ui/public/public_page_button/page_first_prev_btn_01.sub",
