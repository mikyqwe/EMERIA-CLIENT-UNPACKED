	...
	(
		## BOARD
		{
			...
			(
				...
				{
					"name" : "mini_ui_button", "type" : "button", "x" : 15, "y" : 15 + 20, "vertical_align" : "bottom", "text" : "Attiva Tracker", "text_outline" : 1, "text_y" : -1,
				...
				{
					"name" : "reward_button", "type" : "button", "x" : 15 + 120, "y" : 15 + 20, "vertical_align" : "bottom", "horizontal_align" : "right", "text" : "Riscuoti Ricompensa", "text_outline" : 1, "text_y" : -1,
					"default_image" : IMG_PATH + "button_small_normal.sub", "over_image" : IMG_PATH + "button_small_hover.sub", "down_image" : IMG_PATH + "button_small_down.sub", "disable_image" : IMG_PATH + "button_small_down.sub",
				},
			),
		},
